...
class DetailsMonitor extends StatefulWidget {
  DetailsMonitor(
      {super.key,
  ...
  @override
  State<DetailsMonitor> createState() => _DetailsMonitorState();
}

class _DetailsMonitorState extends State<DetailsMonitor> {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: GestureDetector(
                                    ...
                                    //row for review and show review
                                    child: Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                      children: [
                                        //review
                                        Text(
                                          S.of(context).ReviewThisInstructor,
                                          style: TextStyle(
                                              fontSize: 12.sp,
