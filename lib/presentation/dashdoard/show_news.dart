...
import 'Tablet/show_news_tablet.dart';
import 'chossesControl.dart';

class ShowNewsControl extends StatelessWidget {
  const ShowNewsControl({super.key});
        ...
        return Scaffold(
          body: LayoutBuilder(builder: (context, constrain) {
            if (constrain.maxWidth < 600) {
              ...
              return const Center(child: ShowNewsControlTablet());
            } else {
