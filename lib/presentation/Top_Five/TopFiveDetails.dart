...
class TopFiveDetails extends StatefulWidget {
  TopFiveDetails({
    super.key,
  ...
  @override
  State<TopFiveDetails> createState() => _TopFiveDetailsState();
}

class _TopFiveDetailsState extends State<TopFiveDetails> {
  @override
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      widget.topFiveModel.numberUserRate
                                          .toString(),
                                      style: TextStyle(
                                          ...
                                          widget.topFiveModel.rateUser!
                                              ...
                                              : RatingBar.builder(
                                                  ...
                                                  onRatingUpdate:
                                                    ...
                                                    // widget.topFiveModel.rateUser!.contains(FirebaseAuth.instance.currentUser!.uid)?
                                                    //     GetTopFiveCubit.get(context).noAddUserNumber() :
                                                    // GetTopFiveCubit.get(context).addUserNumber();
