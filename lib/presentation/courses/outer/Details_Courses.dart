...
class DetailsCourses extends StatefulWidget {
  DetailsCourses(
      {super.key,
  ...
  @override
  State<DetailsCourses> createState() => _DetailsCoursesState();
}

class _DetailsCoursesState extends State<DetailsCourses> {
  bool isExpanded = true;
  bool isExpanded2 = true;

  bool isExpandedTab = false;
                    ...
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.grey[300],
                          borderRadius: BorderRadius.all(
                            Radius.circular(isExpandedTab ? 20 : 20),
                          ),
                        ),
                        child: Column(
                          children: [
                            ...
                            isExpandedTab ? SizedBox() : SizedBox(height: 20),
                            AnimatedCrossFade(
                              firstChild: const Text(
                                '',
                                style: TextStyle(
