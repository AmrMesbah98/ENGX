...
class RegisterScreenHalfPackage extends StatefulWidget {
  const RegisterScreenHalfPackage({
    super.key,
  });

  @override
  State<RegisterScreenHalfPackage> createState() =>
      _RegisterScreenHalfPackageState();
}

class _RegisterScreenHalfPackageState extends State<RegisterScreenHalfPackage> {
