                                                                      ...
                                                                      ElevatedButton(
                                                                        onPressed:
                                                                          ...
                                                                          await FirebaseFirestore
                                                                            ...
                                                                            DashBoardStudentCubit.get(context).getWeakCollection();
                                                                            DashBoardStudentCubit.get(context).getDashBoardCollection();
                                                                          });

                                                                          const snackBar =
                                                                              SnackBar(content: Text('Done Review '));
