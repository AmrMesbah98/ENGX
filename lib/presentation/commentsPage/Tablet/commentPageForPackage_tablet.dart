...
class CommentPageForPackageTablet extends StatefulWidget {
  CommentPageForPackageTablet({
    super.key,
  ...
  @override
  State<CommentPageForPackageTablet> createState() => _CommentPageForPackageTabletState();
}

class _CommentPageForPackageTabletState extends State<CommentPageForPackageTablet> {
  @override
  void initState() {
                      ...
                      child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      //for rate
                                      constantvar.zeroRate.contains(widget.packageCourseModel.rate!)?
                                      zeroRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.oneRate.contains(widget.packageCourseModel.rate!)?
                                      oneRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.twoRate.contains(widget.packageCourseModel.rate!)?
                                      twoRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.threeRate.contains(widget.packageCourseModel.rate!)?
                                      threeRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.fourRate.contains(widget.packageCourseModel.rate!)?
                                      fourRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.fiveRate.contains(widget.packageCourseModel.rate! )?
                                      fiveRateWidget():
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 2.w,),
                                      Text(widget.packageCourseModel.numberUserRate.toString(),style: TextStyle(fontWeight: FontWeight.w600,fontSize: 9.sp,color: Colors.black54),)
                                    ],
                                  )
                            ...
                            ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemCount: widget.packageCourseModel.comment!.length,
