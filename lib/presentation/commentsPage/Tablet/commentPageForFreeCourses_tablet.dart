...
class CommentPageForFreeCoursesTablet extends StatefulWidget {
  CommentPageForFreeCoursesTablet({
    super.key,
  ...
  @override
  State<CommentPageForFreeCoursesTablet> createState() => _CommentPageForFreeCoursesTabletState();
}

class _CommentPageForFreeCoursesTabletState extends State<CommentPageForFreeCoursesTablet> {
  @override
  void initState() {
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      //for rate
                                      constantvar.zeroRate.contains(widget.freeCoursesModel.rate!)?
                                      zeroRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.oneRate.contains(widget.freeCoursesModel.rate!)?
                                      oneRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.twoRate.contains(widget.freeCoursesModel.rate!)?
                                      twoRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.threeRate.contains(widget.freeCoursesModel.rate!)?
                                      threeRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.fourRate.contains(widget.freeCoursesModel.rate!)?
                                      fourRateWidget():

                                      ////////////////////////////////////////////////////////////////////////////

                                      constantvar.fiveRate.contains(widget.freeCoursesModel.rate! )?
                                      fiveRateWidget():
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 2.w,),
                                      Text(widget.freeCoursesModel.numberUserRate.toString(),style: TextStyle(fontWeight: FontWeight.w600,fontSize: 9.sp,color: Colors.black54),)
                                    ],
                                  )
