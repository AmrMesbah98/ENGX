...
class CommentPageForCourses extends StatefulWidget {
  ...
  @override
  State<CommentPageForCourses> createState() => _CommentPageForCoursesState();
}

class _CommentPageForCoursesState extends State<CommentPageForCourses> {
  @override
  void initState() {
        ...
        return Scaffold(
          ...
          body: LayoutBuilder(builder: (context, constrain) {
            if (constrain.maxWidth < 600) {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          widget.coursesModel.numberUserRate
                                              .toString(),
                                          style: TextStyle(
                                              fontWeight: FontWeight.w600,
                                              fontSize: 11.sp,
              ...
              return  Center(child: CommentPageForCoursesTablet(
                coursesModel: constantvar.coursesModel!,
                id: constantvar.coursesModel!.id!,
              ));
            } else {
