...
import 'Tablet/commentPageForInstructor_tablet.dart';

class CommentPageForInstructor extends StatefulWidget {
  ...
  @override
  State<CommentPageForInstructor> createState() => _CommentPageForInstructorState();
}

class _CommentPageForInstructorState extends State<CommentPageForInstructor> {
  @override
  ...
  builder: (context, state) {
    ...
    builder: (context, constrain){
      if (constrain.maxWidth < 600){
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 2.w,),
                                  Text(widget.instructorModel.numberUserRate.toString(),style: TextStyle(fontWeight: FontWeight.w600,fontSize: 11.sp,color: Colors.black54),)
                                ],
                              )
        ...
        return  Center(child: CommentPageForInstructorTablet(
          instructorModel: constantvar.instructorModel!,
